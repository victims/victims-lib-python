...
if sys.version_info[:2] != (2, 7): # pragma: no cover
    raise ImportError('This version of mnfy supports only python 2.7, for python 3, use mnfy from http://mnfy.rtfd.org/')
...
class SourceCode(ast.NodeVisitor):
    ...
    **exactly** the same (i.e., the AST can be roundtripped).
    ...
    def visit_With(self, node):
		...
		##node.items = a list of withItems, but 2.7 only has 1.
